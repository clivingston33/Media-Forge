import type { ConvertTarget } from '../../types/media'

interface TargetPresetListProps {
  presets: ConvertTarget[]
  selected: ConvertTarget
  onSelect: (preset: ConvertTarget) => void
}

export function TargetPresetList({ presets, selected, onSelect }: TargetPresetListProps) {
  return (
